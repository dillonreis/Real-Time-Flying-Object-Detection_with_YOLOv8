...
\begin{figure*}[h]
    \centering
    \subfloat[\centering Transfer Image Brids1 \label{fig:Transfer_Image_Brids1}]{{ \includegraphics[width=0.2 \textwidth]{figures/Transfer_Image_Brids1.jpg}}}
    \qquad
    \centering
    \subfloat[\centering Transfer Image Drone1 \label{fig:Transfer_Image1_Drone1}]{{ \includegraphics[width=0.2 \textwidth]{figures/Transfer_Image1_Drone1.jpg}}}
    \qquad
    \centering
    \subfloat[\centering Transfer Image Drone2 \label{fig:Transfer_Image1_Drone2}]{{ \includegraphics[width=0.2 \textwidth]{figures/Transfer_Image_Brids1.jpg}}}
    \qquad
    \centering
    \subfloat[\centering Transfer Image Plane1 \label{fig:Transfer_Image1_Plane1}]{{ \includegraphics[width=0.2 \textwidth]{figures/Transfer_Image1_Plane1.jpg}}}
...
\begin{figure*}[h]
    \centering
    \subfloat[\centering Original Image Brids1 \label{fig:Original_Image_Bird1}]{{ \includegraphics[width=0.2 \textwidth]{figures/Original_Image_Bird1.jpg}}}
    \qquad
    \centering
    \subfloat[\centering Original Image Drone1 \label{fig:Original_Image_Drone1}]{{ \includegraphics[width=0.2 \textwidth]{figures/Original_Image_Drone1.jpg}}}
    \qquad
    \centering
    \subfloat[\centering Original Image Heli1 \label{fig:Original_Image_Heli1}]{{ \includegraphics[width=0.2 \textwidth]{figures/Original_Image_Heli1.jpg}}}
    \qquad
    \centering
    \subfloat[\centering Original Image Plane1 \label{fig:Original_Image_Plane1}]{{ \includegraphics[width=0.2 \textwidth]{figures/Original_Image_Plane1.jpg}}}
    \caption{Original Learning Images}%
    \label{fig:TransferImages}
\end{figure*}
% \begin{figure*}[h]
%     \centering
