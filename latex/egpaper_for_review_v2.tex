...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.45\textwidth]{figures/Pre-Trained YOLOv8 Val mAP50-95.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.45\textwidth]{figures/Pre-Trained YOLOv8 Medium vs Mstar Val mAP50-95.png}
