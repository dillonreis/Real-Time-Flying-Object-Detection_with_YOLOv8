...
\begin{figure*}[h]
    \centering
    \subfloat[\centering Generalized Model Images \label{fig:GeneralizedModel}]{{ \includegraphics[width=1 \textwidth]{figures/Generalized_Images.png}}}\hspace{0.1em}
    \centering    
    \subfloat[\centering Refined Model - Transfer Learning Images \label{fig:RefinedModel}]{{\includegraphics[width=1 \textwidth]{figures/Refined_Model_Images.png}}}    
